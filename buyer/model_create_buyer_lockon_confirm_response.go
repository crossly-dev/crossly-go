...
// CreateBuyerLockonConfirmResponse struct for CreateBuyerLockonConfirmResponse
type CreateBuyerLockonConfirmResponse struct {
...
func NewCreateBuyerLockonConfirmResponse(lockonId string, status string, candidates []CreateBuyerLockonObserveResponseCandidates, observationCount float32, visionCalls float32, visionQuotaExhausted bool, verdict string, alternates []GetBuyerAnywhereResponseAlternates, shippingUnknown bool, hud CreateBuyerIdentifyResponseHud) *CreateBuyerLockonConfirmResponse {
	this := CreateBuyerLockonConfirmResponse{}
...
func (o *CreateBuyerLockonConfirmResponse) SetIdentifierNil() {
...
func (o *CreateBuyerLockonConfirmResponse) SetCrosslyNil() {
	o.Crossly.Set(nil)
}
...
func (o *CreateBuyerLockonConfirmResponse) SetOffsiteNil() {
	o.Offsite.Set(nil)
}
...
func (o *CreateBuyerLockonConfirmResponse) SetSavingCentsNil() {
...
func (o CreateBuyerLockonConfirmResponse) MarshalJSON() ([]byte, error) {
...
type NullableCreateBuyerLockonConfirmResponse struct {
	value *CreateBuyerLockonConfirmResponse
	isSet bool
}

func (v NullableCreateBuyerLockonConfirmResponse) Get() *CreateBuyerLockonConfirmResponse {
	return v.value
}

func (v *NullableCreateBuyerLockonConfirmResponse) Set(val *CreateBuyerLockonConfirmResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateBuyerLockonConfirmResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateBuyerLockonConfirmResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateBuyerLockonConfirmResponse(val *CreateBuyerLockonConfirmResponse) *NullableCreateBuyerLockonConfirmResponse {
	return &NullableCreateBuyerLockonConfirmResponse{value: val, isSet: true}
}

func (v NullableCreateBuyerLockonConfirmResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateBuyerLockonConfirmResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
