...
// CreateBuyerMonitorResponse struct for CreateBuyerMonitorResponse
type CreateBuyerMonitorResponse struct {
...
func NewCreateBuyerMonitorResponse(active bool, matchCount float32, createdAt string, id string, name string, kind string, delivery string) *CreateBuyerMonitorResponse {
	this := CreateBuyerMonitorResponse{}
	this.Active = active
...
func (o *CreateBuyerMonitorResponse) SetPausedReasonNil() {
...
func (o *CreateBuyerMonitorResponse) SetLastCheckedAtNil() {
...
func (o *CreateBuyerMonitorResponse) SetLastMatchAtNil() {
...
func (o *CreateBuyerMonitorResponse) SetWebhookSecretNil() {
...
func (o *CreateBuyerMonitorResponse) SetWebhookUrlNil() {
...
func (o CreateBuyerMonitorResponse) MarshalJSON() ([]byte, error) {
...
type NullableCreateBuyerMonitorResponse struct {
	value *CreateBuyerMonitorResponse
	isSet bool
}

func (v NullableCreateBuyerMonitorResponse) Get() *CreateBuyerMonitorResponse {
	return v.value
}

func (v *NullableCreateBuyerMonitorResponse) Set(val *CreateBuyerMonitorResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateBuyerMonitorResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateBuyerMonitorResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateBuyerMonitorResponse(val *CreateBuyerMonitorResponse) *NullableCreateBuyerMonitorResponse {
	return &NullableCreateBuyerMonitorResponse{value: val, isSet: true}
}

func (v NullableCreateBuyerMonitorResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateBuyerMonitorResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
