...
------------ | ------------- | ------------- | -------------
**Page** | **int32** | 1-indexed page number. | 
**Limit** | **int32** | Rows per page. | 
**Total** | Pointer to **int32** | Total matching rows, when the endpoint counts them. | [optional] 
**TotalPages** | Pointer to **int32** | Derived from total and limit. | [optional] 
